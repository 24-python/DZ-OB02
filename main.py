...
print(f"Пользователь добавлен в систему: {[user.get_name() for user in admin.get_users()]}")

# Администратор удаляет пользователя из системы
admin.remove_user(1)
print(f"Пользователь удален из системы: {[user.get_name() for user in admin.get_users()]}")